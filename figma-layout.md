...
- Primary (#125DA3): Main call-to-action buttons, active highlights, and strong emphasis.
- Background (#FFFFFF): Page background and large canvas areas.
- Surface (#ECE6F0): Cards, panels, modals, and elevated containers.
- Text (#161414): Headings, body copy, and primary reading content.
- Border (#D9D9D9): Subtle dividers, input borders, and low-emphasis outlines.
- Muted Text (#79747E): Secondary copy, helper text, and low-emphasis metadata.
- Supporting Color (#0B0B0B): Secondary or contextual color requiring manual semantic review before reuse as a primary accent.
- Supporting Color (#060000): Secondary or contextual color requiring manual semantic review before reuse as a primary accent.
- Supporting Color (#131A9F): Secondary or contextual color requiring manual semantic review before reuse as a primary accent.
...
### Buttons
- **Primary**: #125DA3 fill, #FFFFFF text, no border, radius 8px.
- **Primary Hover**: #105493 fill, #FFFFFF text, no border.
- **Primary Focus**: #125DA3 fill, #FFFFFF text, 3px ring #125DA31F.
- **Primary Disabled**: #125DA3 fill, #FFFFFF text, 40% opacity.

- **Secondary**: transparent fill, #161414 text, 1px #D9D9D9 border, radius 8px.
- **Secondary Hover**: #1614140A fill, #161414 text, 1px #D9D9D9 border.
- **Secondary Focus**: transparent fill, #161414 text, 1px #125DA3 border, 3px ring #125DA31F.
- **Secondary Disabled**: transparent fill, #79747E text, 1px #D9D9D9 border, 40% opacity.

- **Ghost**: transparent fill, #79747E text, no border, radius 8px.
- **Ghost Hover**: #16141406 fill, #161414 text, no border.
- **Ghost Focus**: transparent fill, #161414 text, 3px ring #125DA31F.
- **Ghost Disabled**: transparent fill, #79747E text, no border, 40% opacity.

### Cards
- **Default**: #ECE6F0 fill, 1px #D9D9D9 border, radius 8px.
- **Elevated**: #ECE6F0 fill, soft elevation, radius 8px.
- **Large Panel**: #ECE6F0 fill, subtle border or elevation, radius 16px.

### Inputs
- **Default**: #ECE6F0 fill, 1px #D9D9D9 border, text color #161414, radius 8px.
- **Hover**: #ECE6F0 fill, 1px #B2B2B2 border, text color #161414.
- **Focus**: #ECE6F0 fill, 1px #125DA3 border, 3px ring #125DA31F.
- **Error**: #ECE6F0 fill, 1px #EF4444 border, 3px ring #EF44441F.
- **Disabled**: #EDE8F1 fill, 1px #D9D9D9 border, text color #79747E, 40% opacity.

### Layout Containers
- Use #ECE6F0 for contained regions.
...
1. **Do** use #125DA3 for key interactive emphasis only.
2. **Do** keep page backgrounds consistent with #FFFFFF.
3. **Do** preserve strong readability with #161414 for core reading content.
...
- Auto-generated from Figma on 2026-05-15.
- Source of truth: Figma file.
- File: mockups n1 uix
- Scope: Current Page
- Root nodes scanned: 33
- Auto layout containers found: 31
